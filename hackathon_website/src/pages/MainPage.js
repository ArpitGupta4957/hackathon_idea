...
const PageTitle = styled.h1`
  ...
  text-shadow: 0 2px 12px #00c89622;
`;
...
const StatsCard = styled.div`
  ...
  padding: 2rem;
  border-radius: 18px;
  box-shadow: 0 6px 24px 0 #00c89622;
  border: 2px solid #e0ffe6;
  display: flex;
  align-items: center;
  gap: 1rem;
  ...
  &:hover {
    ...
    box-shadow: 0 12px 32px 0 #00c89633;
    border-color: #00c896;
  }
`;
...
const ChartCard = styled.div`
  ...
  padding: 2rem;
  border-radius: 18px;
  box-shadow: 0 6px 24px 0 #00bfff22;
...
const StockInputSection = styled.div`
  ...
  padding: 1.5rem;
  border-radius: 15px;
  box-shadow: 0 4px 16px 0 #38a16922;
  border: 2px solid #e0ffe6;
  margin-bottom: 2rem;
  display: flex;
  align-items: center;
